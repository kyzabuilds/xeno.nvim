...
t.describe("applied highlights", function()
  ...
  t.it("keeps TSX semantic variables neutral to avoid LSP pop-in", function()
    ...
    t.eq(t.get_hl("@lsp.type.property.typescriptreact").fg, t.get_hl("@property").fg)
    t.eq(t.get_hl("@lsp.mod.declaration.typescriptreact").fg, nil)
    t.eq(t.get_hl("@lsp.typemod.property.declaration.typescriptreact").fg, t.get_hl("@property").fg)
