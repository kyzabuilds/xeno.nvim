...
function M.generate_syntax_highlights(colors)
  return {
    ...
    Identifier = { fg = colors.foreground_400 },
    ...
    SpecialComment = { fg = colors.foreground_400, italic = true },

    -- Accent syntax continues to use the accent family directly.
    Constant = { fg = colors.accent_200 },
    Number = { fg = colors.accent_200 },
    String = { fg = colors.accent_200 },
    Statement = { fg = colors.accent_200 },
    Conditional = { fg = colors.accent_200 },
    Repeat = { fg = colors.accent_200 },
    Label = { fg = colors.accent_300 },
    Keyword = { fg = colors.accent_300 },
    Exception = { fg = colors.accent_300 },
    PreProc = { fg = colors.accent_300 },
    Include = { fg = colors.accent_300 },
    Define = { fg = colors.accent_300 },
    Macro = { fg = colors.accent_300 },
    PreCondit = { fg = colors.accent_300 },
    Type = { fg = colors.accent_300 },
    StorageClass = { fg = colors.accent_300 },
    Structure = { fg = colors.accent_300 },
    Typedef = { fg = colors.accent_300 },
    Tag = { fg = colors.accent_300 },
    Debug = { fg = colors.accent_300 },
    Todo = { fg = colors.accent_300, italic = true, bold = true },
    ...
    ["@variable"] = { fg = colors.foreground_300 },
    ...
    ["@function.method"] = { fg = colors.accent_100 },
    ...
    -- Base LSP group: cleared so @lsp.mod.readonly.* and @lsp.typemod.*.readonly.*
    -- links don't inherit Normal fg and override treesitter at higher priority
    ["@lsp"] = { clear = true },
